    ...
    return (
        <DashboardLayout>
            <SettingsLayout>
                    ...
                    <div className="flex-1 flex items-center justify-end gap-2">
                        <div className="relative w-full max-w-md">
                            <input
                                ...
                                className="w-full px-4 py-2 text-sm font-medium border rounded-md focus:outline-none focus:border-red-400"
                            />
                        </div>
                        <Link
                            to="/settings/categories/create"
                            className="flex items-center gap-2 px-4 py-2 bg-red-400 text-white text-sm font-medium rounded-md hover:bg-red-500 transition-colors duration-200">
                            <Plus size={18}/>
                            Add New Category
                        </Link>
                    </div>
                                ...
                                <td className="px-4 py-3 text-right text-sm">
                                    <div className="flex justify-end gap-4">
                                        <button
                                            ...
                                            className="flex items-center gap-1 text-sm font-medium text-muted-foreground hover:underline"
                                        >
                                            <PencilLine size={12}/>
                                            Edit
                                        </button>
                ...
                {/*                    <p className="text-gray-500 dark:text-gray-400">Brings all your news into one*/}
                {/*                        place</p>*/}
                {/*                </div>*/}
                {/*            </td>*/}
                {/*            <td className="px-4 py-4 text-sm whitespace-nowrap">*/}
                ...
                {/*                    <p className="text-gray-500 dark:text-gray-400">Time tracking, invoicing and*/}
                {/*                        expenses</p>*/}
                {/*                </div>*/}
                {/*            </td>*/}
                {/*            <td className="px-4 py-4 text-sm whitespace-nowrap">*/}
